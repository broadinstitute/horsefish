...
# check this link for a nicer way to do this maybe: https://stackoverflow.com/questions/34157811/filter-a-pandas-dataframe-using-values-from-a-dict
...
# PLOTTING ASSEMBLY LENGTH
def plot_assembly_length(data, sample_names, group_column, threshold_dict, metric_name):
    """Plot contigs data."""
    ...
    # PLOT ALL SAMPLES ALL ORGANISM
    all_organisms = create_scatter_plot(data, sample_names, metric_name, group_column)
    # set labels
    all_organisms.set_title("Assembly Length per Sample", size = 14, fontweight='bold')
    all_organisms.set_xlabel("Sample ID", size = 14)
    all_organisms.set_ylabel("Assembly Length", size = 14)
    ...
    # PLOT ALL SAMPLES PER ORGANISM
    per_organism = create_scatter_plot_by_group(data, sample_names, metric_name, group_column)
    # set labels
    per_organism.fig.suptitle("Assembly Length per Sample by Organism", size=14, fontweight="bold", y=1.0)
    per_organism.tick_params(labelrotation=90)
    # assembly_org.set_axis_labels("Sample ID")
    per_organism.set_ylabels("Assembly Length Mbp")
...
# PLOTTING CONTIGS
def plot_contigs(data, sample_names, group_column, threshold_dict, metric_name):
    """Plot contigs data."""
    ...
    all_organisms = create_scatter_plot(data, sample_names, metric_name, group_column)
    # set labels
    all_organisms.set_title("Number Contigs per Sample", size = 14, fontweight='bold')
    all_organisms.set_xlabel("Sample ID", size = 14)
    all_organisms.set_ylabel("Number Contigs", size = 14)
    all_organisms.legend(title='Organism', loc='upper right')
    # set ticks
    all_organisms.tick_params(labelrotation=90)
    ...
    per_organism = create_scatter_plot_by_group(data, sample_names, metric_name, group_column)
    # set labels
    per_organism.fig.suptitle("Number Contigs per Sample by Organism", size=14, fontweight="bold", y=1.0)
    per_organism.tick_params(labelrotation=90)
    # contig_org.set_axis_labels("Sample ID")
    per_organism.set_ylabels("Number Contigs")
    per_organism.set_xlabels("Sample ID")
...
# PLOTTING ESTIMATED COVERAGE
def plot_estimated_coverage(data, sample_names, group_column, threshold_dict, metric_name):
    ...
    all_organisms = create_scatter_plot(data, sample_names, metric_name, group_column)
    # set labels
    all_organisms.set_title("Estimated Coverage per Sample", size = 14, fontweight='bold')
    all_organisms.set_xlabel("Sample ID", size = 14)
    all_organisms.set_ylabel("Estimated Coverage", size = 14)
    all_organisms.legend(title='Organism', loc='upper right')
    # set ticks
    all_organisms.tick_params(labelrotation=90)
    ...
    per_organism = create_scatter_plot_by_group(data, sample_names, metric_name, group_column)
    # set labels
    per_organism.fig.suptitle("Estimated Coverage per Sample by Organism", size=14, fontweight="bold", y=1.0)
    per_organism.tick_params(labelrotation=90)
    # est_cov_org.set_axis_labels("Sample ID")
    per_organism.set_ylabels("Estimated Coverage")
    per_organism.set_xlabels("Sample ID")
    # automatically space between rows of subplots of FacetGrid
    per_organism.fig.tight_layout()
