...
# 'required' is, ironically, an optional header
    ...
    with open(filename, encoding='utf-8') as csvf:
        ...
        for row in csvReader:
            ...
            data_to_append = {
                ...
                "array_of": bool(row["array_of"])
                }
            if "required" in column_names:
                data_to_append["required"] = bool(row["required"])

            columns.append(data_to_append)
    return columns
