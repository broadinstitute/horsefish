"""Put/update/post Dataset attributes to workspaces parsed from input tsv file.
...
def publish_single_workspace_dataset_attributes(request, workspace_name, project="anvil-datastorage"):
...
def setup_dataset_publishing_workspaces(tsv, project="anvil-datastorage"):
    ...
    col_names = ["input_workspace_name", "input_project_name",
                 "workspace_link", "post_dataset_attributes_status",
    ...
    for workspace in all_workspaces_modified_df.index:
        ...
        row_dict = publish_single_workspace_dataset_attributes(validated_json, workspace, project)
    ...
    write_output_report(published_workspace_statuses, "dataset_attributes_published")
...
if __name__ == "__main__":
    ...
    setup_dataset_publishing_workspaces(args.tsv, args.workspace_project)
